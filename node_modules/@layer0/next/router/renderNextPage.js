...
const addPreloadHeaders_1 = __importDefault(require("@layer0/core/router/addPreloadHeaders"));
const constants_1 = require("@layer0/core/constants");
const nextPathFormatter_1 = require("./nextPathFormatter");
const qs_1 = __importDefault(require("qs"));
const bindParamsToPath_1 = __importDefault(require("@layer0/core/utils/bindParamsToPath"));
/**
 ...
 */
async function renderNextPage(page, responseWriter, params, options = { rewritePath: true }) {
...
exports.default = renderNextPage;
/**
 ...
 * @param params
 */
function rewritePath(request, page, params) {
    let destinationRoute = nextPathFormatter_1.toRouteSyntax(page);

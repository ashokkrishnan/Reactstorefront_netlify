 ...
 */
export default function renderNextPage(page: string, responseWriter: ResponseWriter, params?: Params | ((p: Params, request: Request) => Params), options?: RenderOptions): Promise<void>;

...
function createBuildEntryPoint({ srcDir, distDir, buildCommand }) {
    ...
    return async function build(options) {
        ...
        builder
            ...
            .addJSAsset(path_1.join(distDirAbsolute, 'serverless'), undefined, lambdaAssetCopyOptions)
        ...
        setSsgStaticAssetExpiration_1.default(builder, prerenderManifest, distDir);
        await builder.build();
        const pages = path_1.join(builder.jsDir, distDir, 'serverless', 'pages');
        ...
        globby_1.default
            ...
            builder.addStaticAsset(src, path_1.join(distDir, 'serverless', 'pages', file));
            builder.removeSync(src);
        });
        const defaultLocale = (_a = nextConfig.i18n) === null || _a === void 0 ? void 0 : _a.defaultLocale;
        const staticPagesDir = path_1.join(builder.staticAssetsDir, distDir, 'serverless', 'pages');
        if (defaultLocale) {
            ...
            if (fs_1.existsSync(indexHtml)) {
                builder.copySync(indexHtml, path_1.join(staticPagesDir, '.html'));
            }

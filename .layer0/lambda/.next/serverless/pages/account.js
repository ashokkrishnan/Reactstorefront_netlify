...
/******/ 	return __webpack_require__(__webpack_require__.s = "ub27");
/******/ })
/************************************************************************/
/******/ ({
...
const Loader = /*#__PURE__*/react_default.a.memo(({
  active
}) => {
  const classes = useStyles();
...
function LoginForm() {
  ...
  const signIn = async () => {
    ...
    try {
      ...
      setSignInError(get_default()(error, 'message', 'Sign in error, please check your credentials'));
    } finally {
      setLoading(false);
    }
  };
  ...
  const signUp = async () => {
    ...
    try {
      ...
      setSignUpError(get_default()(error, 'message', 'An error occurred during sign up'));
    } finally {
      setLoading(false);
    }
  };
  ...
  return /*#__PURE__*/Object(jsx_runtime["jsx"])(jsx_runtime["Fragment"], {
    children: /*#__PURE__*/Object(jsx_runtime["jsxs"])(Container["a" /* default */], {
      className: classes.root,
      children: [/*#__PURE__*/Object(jsx_runtime["jsx"])(Loader, {
        active: loading
      }), !signedIn ? /*#__PURE__*/Object(jsx_runtime["jsxs"])(jsx_runtime["Fragment"], {
        ...
        }), signInError && /*#__PURE__*/Object(jsx_runtime["jsx"])("div", {
          className: classes.spacingBlock,
        ...
        }), signUpError && /*#__PURE__*/Object(jsx_runtime["jsx"])("div", {
          className: classes.spacingBlock,
          children: /*#__PURE__*/Object(jsx_runtime["jsx"])("b", {
            style: {
              color: '#f00'
...
const account_useStyles = Object(makeStyles["a" /* default */])(theme => ({
  main: {
    display: 'flex',
    alignItems: 'center',
...
function Index(lazyProps) {
  ...
  const [state] = useLazyState_default()(lazyProps);
  return /*#__PURE__*/Object(jsx_runtime["jsxs"])(jsx_runtime["Fragment"], {
    children: [state.loading ? null : /*#__PURE__*/Object(jsx_runtime["jsx"])(head_default.a, {
      children: /*#__PURE__*/Object(jsx_runtime["jsx"])("title", {
        children: get_default()(state, 'pageData.title')
      })
      ...
      children: [/*#__PURE__*/Object(jsx_runtime["jsx"])(Typography["a" /* default */], {
        ...
        children: "Account"
      }), /*#__PURE__*/Object(jsx_runtime["jsx"])(react_storefront_analytics["TrackPageView"], {}), /*#__PURE__*/Object(jsx_runtime["jsx"])("div", {
        className: classes.main,
...
Index.getInitialProps = createLazyProps_default()(fetchFromAPI_default.a);
const config = {
  amp: 'hybrid'
};
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__);
      ...
      const compMod = __webpack_require__("cdae")

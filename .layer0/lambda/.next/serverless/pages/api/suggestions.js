...
/******/ 	return __webpack_require__(__webpack_require__.s = "TIYM");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_api_handler__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(next_dist_build_webpack_loaders_next_serverless_loader_api_handler__WEBPACK_IMPORTED_MODULE_2__);
      ...
      processEnv([])
        ...
        const apiHandler = Object(next_dist_build_webpack_loaders_next_serverless_loader_api_handler__WEBPACK_IMPORTED_MODULE_2__["getApiHandler"])({
          pageModule: __webpack_require__("q08q"),
          rewrites: combinedRewrites,
          i18n: undefined,
          page: "/api/suggestions",
          basePath: "",
          pageIsDynamic: false,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return searchSuggestionsPage; });
...
async function searchSuggestionsPage(req, res) {
  const {
    q
  } = req.query;
  res.json(await Object(react_storefront_connector__WEBPACK_IMPORTED_MODULE_0__["searchSuggestions"])(q, req, res));
}
